    ...
    public class CategoriasController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Categoria != null ? 
                          View(await _context.Categoria.OrderBy(c => c.Descricao).ToListAsync()) :
        ...
        [HttpPost]
        public JsonResult ValidaCadastro(string descricao)
        {
            Categoria categoria = _context.Categoria.Where(c => c.Descricao == descricao).ToList().FirstOrDefault();
            if (categoria != null)
            {
                return Json("s");
            }
