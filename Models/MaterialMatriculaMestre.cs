...
namespace Inveni.Models {
    public class MaterialMatriculaMestre {
        ...
        [Required]
        public bool AtivoAprendiz { get; set; } = true;  // Atributo booleano com valor padrão true

        // Construtor
        public MaterialMatriculaMestre() {
            AtivoAprendiz = true;  // Garante que o valor padrão seja true
        }
    }
}
